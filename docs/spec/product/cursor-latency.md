cursor-latency[launcher-button]
...
cursor-latency[playground.window]
...
cursor-latency[playground.behavior-controls]
...
cursor-latency[playground.fastest]
...
cursor-latency[playground.match-os]
...
cursor-latency[playground.polygon]
...
cursor-latency[playground.split-halves]
...
cursor-latency[playground.ripple-sdf]
...
cursor-latency[overlay.hide-after-pause]
...
cursor-latency[overlay.frame-graph]
