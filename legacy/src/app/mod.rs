...
pub use audio_transcription::{
    ...
    WhisperLogMel80x3000, audio_transcription_available_model_names,
    audio_transcription_control_request_for_queued_audio_request,
    audio_transcription_control_request_for_queued_request, audio_transcription_daemon_status,
    audio_transcription_daemon_status_with_pool_status,
    audio_transcription_f32_samples_to_little_endian_bytes, audio_transcription_named_pipe_path,
    audio_transcription_named_pipe_request_roundtrip,
    audio_transcription_prepare_handoff_tensor_from_samples,
    audio_transcription_resample_mono_to_16khz, audio_transcription_run_python_cuda_check,
    ...
    audio_transcription_select_model_index, audio_transcription_selected_model_index,
