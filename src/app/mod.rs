...
pub use audio_transcription::{
    ...
    WhisperLogMel80x3000, audio_transcription_control_request_for_queued_audio_request,
    ...
    audio_transcription_resample_mono_to_16khz, audio_transcription_run_python_debug_request_once,
