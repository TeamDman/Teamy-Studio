...
- `[next]` implement and verify Teamy colorization and SGR coverage so shell prompts, command output, selection contrast, and future parity checks stop using the current single-color fallback
